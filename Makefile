...
pkgdatadir = $(datadir)/duc
pkgincludedir = $(includedir)/duc
pkglibdir = $(libdir)/duc
pkglibexecdir = $(libexecdir)/duc
...
ACLOCAL = ${SHELL} /tmp/duc/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /tmp/duc/missing autoconf
AUTOHEADER = ${SHELL} /tmp/duc/missing autoheader
AUTOMAKE = ${SHELL} /tmp/duc/missing automake-1.14
AWK = mawk
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /tmp/duc/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
VERSION = 0.1
abs_builddir = /tmp/duc
abs_srcdir = /tmp/duc
abs_top_builddir = /tmp/duc
abs_top_srcdir = /tmp/duc
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__leading_dot = .
...
install_sh = ${SHELL} /tmp/duc/install-sh
